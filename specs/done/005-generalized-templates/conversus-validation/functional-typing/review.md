...
- `/Users/business-daddy/code/payer-index-mono/conversus/.specify/memory/constitution.md` -- Principle IX (Functional Programming and Clean Code, Explicit Typing)
- `/Users/business-daddy/code/payer-index-mono/conversus/specs/005-generalized-templates/conversus-review/summary/final.md` -- Prior review convergence record (P1-1 through P1-5, P2-1 through P2-9, P3-1 through P3-8)
- `/Users/business-daddy/code/payer-index-mono/conversus/linter/models.py` -- Pydantic models (lines 1-347)
- `/Users/business-daddy/code/payer-index-mono/conversus/linter/validate.py` -- Linter implementation (lines 1-417)
- `/Users/business-daddy/code/payer-index-mono/conversus/linter/test_validate.py` -- Test suite (360 tests, lines 1-586)
- `/Users/business-daddy/code/payer-index-mono/conversus/schema/variables.yml` -- Variable schema (lines 1-468)
- `/Users/business-daddy/code/payer-index-mono/conversus/schema/modes/cooperative.yml` -- Mode schema (lines 1-50)
- `/Users/business-daddy/code/payer-index-mono/conversus/schema/modes/red-blue.yml` -- Mode schema (lines 1-49)
- `/Users/business-daddy/code/payer-index-mono/conversus/schema/modes/winner-take-all.yml` -- Mode schema (lines 1-47)
- `/Users/business-daddy/code/payer-index-mono/conversus/schema/modes/prisoners-dilemma.yml` -- Mode schema (lines 1-44)
- `/Users/business-daddy/code/payer-index-mono/conversus/pyproject.toml` -- Package config (lines 1-18)
- `/Users/business-daddy/code/payer-index-mono/conversus/specs/005-generalized-templates/spec.md` -- Spec with Section 8 extension points (lines 399-421)
