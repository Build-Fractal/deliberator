...
- **Evidence**: Backbone researcher §7 (common pattern table), §10 (tool-by-tool CLI surface), §11.2 (de facto backbone). Monorepo integrator architecture at `<HOME>/code/payer-index-mono/apm/src/apm_cli/integration/base_integrator.py`.
