...
**Governed by:** `https://github.com/Build-Fractal/build-fractal-mono/blob/main/conversus/GOVERNANCE.md` § Pathway Taxonomy (**MINOR** pathway at Tier 2 — strengthens the suite constitution without removing or renaming any existing principle).
