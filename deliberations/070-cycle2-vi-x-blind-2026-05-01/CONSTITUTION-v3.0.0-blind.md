...
- **Constitutional Inclusion Criteria** (added v2.4.0): a principle
  ...
  **Grandfathered-principle headline rewrites (path (c)).** A headline
  ...
  applies only to genuinely new content. The amendment establishing this definition is the canonical
  path (c) precedent for future grandfathered-principle remediation.
