...
Spec 064 added :func:`~deliberator.registry.discovery.collect_capabilities`
...
:meth:`~deliberator.registry.adapters.base.MCPAdapter.render` returns
...
from deliberator.registry.discovery import collect_capabilities
...
#: :mod:`deliberator.registry.adapters.mcp` so dynamically-registered
#: tools share the namespace with build-time-codegened ones.
_MCP_TOOL_PREFIX = "deliberator_"
