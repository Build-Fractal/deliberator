...
from deliberator.registry.adapters import (
    CLIAdapter,
    DefaultCLIAdapter,
    DefaultMCPAdapter,
    DefaultMCPBAdapter,
...
from deliberator.registry.discovery import CAPABILITY_GROUPS, collect_capabilities
from deliberator.registry.params import Param, Surface
from deliberator.registry.registry import for_surface, get
from deliberator.registry.runtime import (
