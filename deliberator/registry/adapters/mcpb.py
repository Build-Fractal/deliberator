...
Generated entry shape::
    ...
    {
      "name": "deliberator_hello",
      "description": "Say hello to someone"
    }

The ``name`` field uses the ``deliberator_`` prefix — identical to the MCP
...
from deliberator.registry.adapters.base import MCPBAdapter
from deliberator.registry.adapters.mcp import TOOL_PREFIX
...
class MCPBToolEntry(TypedDict):
    ...
    deliberator only ever emits ``name`` + ``description``. If a future
