...
# deliberation. Handles pre-flight checks, the actual conversus run invocation,
...
DELIB_DIR="deliberations/v4.2.0-structured-deliberation-outputs-originating-2026-05-12"
...
PARTIAL_DIRS=(engineer schema-design-expert adapter-consumer devils-advocate summary arbitration)
cleaned=0
...
start_ts=$(date +%s)
log_file="/tmp/conversus-v4.2.0-originating-$(date +%Y%m%d-%H%M%S).log"
