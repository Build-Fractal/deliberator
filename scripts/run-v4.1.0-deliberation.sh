...
DELIB_DIR="deliberations/v4.1.0-persistence-contract-discipline-originating-2026-05-11"
...
PARTIAL_DIRS=(pragmatist devils-advocate persistence-expert ci-expert summary arbitration)
cleaned=0
...
start_ts=$(date +%s)
log_file="/tmp/conversus-v4.1.0-deliberation-$(date +%Y%m%d-%H%M%S).log"
