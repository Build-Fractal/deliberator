...
DELIB_DIR="deliberations/v4.2.0-structured-deliberation-outputs-self-consistency-2026-05-13"
...
start_ts=$(date +%s)
log_file="/tmp/conversus-v4.2.0-self-consistency-$(date +%Y%m%d-%H%M%S).log"
